...
(function($) {
      ...
      $.ajax({
        ...
        error: function() {
          ...
          $('#success > .alert-danger').html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;")
            .append("</button>");
          $('#success > .alert-danger').append("<strong>Sorry " + firstName + ", it seems that my mail server is not responding. Please try again later or send the message directly to joelpinh@gmail.com!");
  ...
  function init() {
    ...
    var mapOptions = {
      ...
      center: new google.maps.LatLng(40.6303024, -8.657506), // New York           // How you would like to style the map. 
    ...
    var marker = new google.maps.Marker({
      position: new google.maps.LatLng(40.6303024, -8.657506),
      map: map,
