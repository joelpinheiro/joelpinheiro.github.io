...
detailed in the [section 4.4.2.3](#domain-login).
...
dependencies and better decoupled from the protocol. The Pipeline
configuration can reflect the concept of activity diagrams, controlling
the path flow of the message that is dependent of the message type. This
concept is generic enough to contemplate different message flows in the
future.
